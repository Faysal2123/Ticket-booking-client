        ...
        <div className='w-full md:h-[65vh] h-[30vh]'>
            ...
            className=" h-full w-full">
                ...
                <div className='absolute inset-0 bg-black/30 z-10'></div>
                    <img src={slide1} className="h-full w-full object-cover transition-all duration-300 ease-in-out brightness-75 bg-black/30 z-10" alt="" />
                ...
                <SwiperSlide className='relative'>
                <div className='absolute inset-0 bg-black/30 z-10'></div>
                    <img src={slide2} className="h-full w-full object-cover transition-all duration-300 ease-in-out brightness-75 bg-black/30 z-10" alt="" />
                    <div className="absolute inset-0  flex flex-col justify-center text-center z-20 px-2">
                ...
                <SwiperSlide className='relative'>
                <div className='absolute inset-0 bg-black/30 z-10'></div>
                    <img src={slide3} className="h-full w-full object-cover transition-all duration-300 ease-in-out brightness-75 bg-black/30 z-10" alt="" />
                    <div className="absolute inset-0  flex flex-col justify-center text-center z-20 px-2">
                ...
                <SwiperSlide className='relative'>
                    <div className='absolute inset-0 bg-black/30 z-10'></div>
                    <img src={slide4}  className="h-full w-full object-cover transition-all duration-300 ease-in-out bg-black/30 z-10"alt="" />
                    <div className="absolute inset-0  flex flex-col justify-center text-center z-20 px-2">
